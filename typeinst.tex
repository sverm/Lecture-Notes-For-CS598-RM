...
In the manner described in FIG. 1, we can first of all be forced to occupy a very definite point in the constructed gobang situation, namely the point which is to be assigned to the initial point s.
The latent threats of points [5] and [6] are given by two angles as in FIG.

Only after a player has a point of the type [2] in FIG. 7 or FIG. 8, the other player has the choice to respond either to [3] or to [4], since the opponent is forced to return to the opponent can be.
